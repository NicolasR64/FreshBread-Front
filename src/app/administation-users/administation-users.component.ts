...
@Component({
  selector: 'app-administation-users',
  templateUrl: './administation-users.component.html',
  styleUrls: ['./administation-users.component.css']
})
export class AdministationUsersComponent {
  ...
  startEdit(){
    const dialogRef = this.dialogService.open(UpdateUserDialogComponent, {
      data: {issue: {} }
    });
